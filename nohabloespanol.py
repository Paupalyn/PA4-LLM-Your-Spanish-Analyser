...
# Input text area
user_input = st.text_area("Enter your Spanish text ✍️ (with no punctuations, please):", "Escribe algo aquí!", height=200)
            ...
            with st.spinner(random.choice(loading_meme)):  # Add funny loading message
                try:
                    ...
                    try:
                        ...
                        st.error("⚠️ Oopsie It seems like your text contains non-Spanish words or invalid characters, Please try again")
